...
export default defineEventHandler(async (event) => {
  try {
    ...
    console.log("Gelen tarih değerleri:", { 
      OrderDate, 
      RequiredDate, 
      ShippedDate,
    ...
    // Zaman damgalarını doğrudan oluştur
    ...
    console.log("İşlenen tarih değerleri (nesne):", { 
      processedOrderDate, 
      processedRequiredDate, 
      processedShippedDate 
    });
    
    console.log("İşlenen tarih değerleri (string):", { 
    ...
    console.log("Kaydedilen sipariş tarihleri:", { 
    ...
    console.log("==== SIPARIŞ OLUŞTURMA TAMAMLANDI ====");
    ...
    throw createError({
      statusCode: 500,
      statusMessage: `Sipariş oluşturulurken bir hata oluştu: ${error.message}`
    })
  }
}) 